        ...
        <tr>
            <td align="center" valign="middle">
                <div style="background-color: #fff; padding: 30px; max-width: 400px; text-align: center; border-radius: 15px; box-shadow: 0px 0px 15px rgba(0, 0, 0, 0.1);">
                    ...
                    lin :<a href="https://aerorallyes.com/register?id=<?php echo e($flightDetail->id); ?>">Register form</a></p>
...
<?php /**PATH /home/aeroralltt/admin/resources/views/emails/flightDetailsComplete.blade.php ENDPATH**/ ?>