        ...
        <tr>
            <td align="center" valign="middle">
                <div style="background-color: #fff; padding: 30px; max-width: 400px; text-align: center; border-radius: 15px; box-shadow: 0px 0px 15px rgba(0, 0, 0, 0.1);">
                    ...
                    <p style="font-size: 1rem; color: #243475; margin: 10px 0;">Thank you for your pre-registration for our International Air Gathering in Tunisia!</p>
                    <p style="font-size: 1rem; color: #243475; margin: 10px 0;">Your pre-registration has been successfully recorded.</p>
...
<?php /**PATH /home/aeroralltt/admin/resources/views/emails/flightDetails.blade.php ENDPATH**/ ?>